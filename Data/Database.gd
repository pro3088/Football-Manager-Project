...
func getAllPlayers():
	...
	for stat in db.query_result:
		playerstats.append(load("res://Data/TeamData/PlayerData/PlayerData.gd").new(stat.name, stat.country, stat.age, stat.role, stat.shot, stat.pass, stat.cross, stat.curve, stat.form, stat.attack, stat.physique, stat.stamina, stat.defence, stat.dribble, stat.speed))
...
func getClubTeam():
	...
	print_debug(db.error_message)
	for stat in db.query_result:
		clubTeam.append(load("res://Data/TeamData/PlayerData/PlayerData.gd").new(stat.name, stat.country, stat.age, stat.role, stat.shot, stat.pass, stat.cross, stat.curve, stat.form, stat.attack, stat.physique, stat.stamina, stat.defence, stat.dribble, stat.speed))
